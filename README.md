...
1. Использовать встроенные библиотеки. Можно использовать внешние библиотеки, но не фреймворки (описать в **requirements.txt**).
2. Добавить эндпойнт с документацией по разработанному API.
